...
import {
  CustomGridWrapper, HeaderWrapper, LinksWrapper,
  StyledMenuContent,
  StyledMenuList,
  StyledMenuLink
} from './styles'
        ...
        <CustomGridWrapper>
          <div>
            <div className="overflow">
              ...
              >
                <img src='/logovaca.svg' alt='' style={{ width: 'auto', height: '4.5vh' }} />
              </CustomLink>
            </div>
          </div>
          <LinksWrapper>
            ...
            <CustomButton style={{ pointerEvents: 'all' }} id='burger' onClick={() => handleActivate()}>menu</CustomButton>
          </LinksWrapper>
          {/* <CustomButton
